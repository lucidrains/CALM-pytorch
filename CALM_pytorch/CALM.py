    ...
    def __init__(
        ...
        *,
        ...
        for connection, one_augment_transformer_blocks, one_num_augment_blocks in zip(connections, augment_transformer_blocks, num_augment_blocks):
            ...
            one_reversed_augment_blocks = one_augment_transformer_blocks[::-1]
            reversed_augment_blocks_to_hook = [one_reversed_augment_blocks[i - 1] for i in augment_layer_indices]
            augment_blocks_to_hook = reversed_augment_blocks_to_hook[::-1]
